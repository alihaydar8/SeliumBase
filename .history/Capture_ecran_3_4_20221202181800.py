...
driver.get_screenshot_as_file("images/fullscreenshot.png")
driver.find_element(By.CSS_SELECTOR,".orangehrm-login-slot").screenshot("images/form.png")
driver.find_element(By.NAME,"username").screenshot("images/username.png")
