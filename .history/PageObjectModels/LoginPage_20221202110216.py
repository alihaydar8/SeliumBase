...
class Login :
    ...
    def __init__(self,url):
        ...
        self.driver = webdriver.Chrome(chrome_options=options,service=Service(ChromeDriverManager(version='107.0.5304.62').install()))
    ...
    def check_conextion_with_Link_Text_Present(self,locator):
        print (self.find(locator),"element Leave not fund")
