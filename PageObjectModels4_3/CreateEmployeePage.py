...
class CreateEmployeePage:
    ...
    def create(self, firstname, lastname,middlename,employeeIdd):
        ...
        employee_id_input = self.driver.find_element(By.XPATH, "/html[1]/body[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/input[1]")
        employee_id_input.send_keys(Keys.CONTROL, 'a')
        employee_id_input.send_keys(employeeIdd)
        # Submit the form
        submit_button = self.driver.find_element(By.XPATH, "/html[1]/body[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/form[1]/div[2]/button[2]")
        submit_button.click()
